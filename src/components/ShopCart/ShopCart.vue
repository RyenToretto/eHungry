  ...
  export default {
    ...
    computed: {
      ...
      payClass () {
        ...
        return minPrice<=this.totalPrice?"enough":"not-enough"
      },
      payText () {
        const {minPrice} = this.info
      ...
      listShow () {
        if(this.totalCount>0){
          ...
          return this.shouldListShow
        }else{
          this.shouldListShow = false
          return false
        }
      }
    },
    methods: {
      toggleShow () {
        if(this.totalCount>0){
          this.shouldListShow = !this.shouldListShow
        }
      },
      async clearCart () {
        await this.$store.dispatch("clearFoodCount")
      },
    }
  }
</script>
